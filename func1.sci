...
function x = signal(t)
   ...
   //x = 3 * sin(100 * %pi *t)
   x = 3 *cos(600 *%pi * t) + 2 * sin(1800 * %pi * t)
endfunction
...
//delta_input = input("Quantization Step: ");
...
fd = mopen("C:\Users\16526\Desktop\SciLab_code\Lib\output.txt",'wt');
